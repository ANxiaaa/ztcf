<template>
    <div class="login">
        <div class="title t600">
            <h5>登录郑泰车服</h5>
            <p>若账号未设置密码, 请用验证码登录</p>
        </div>
        <div class="tmpinput">
            <btmborder @getData="getPhone" name="账号" placeholder="请输入您的手机号/邮箱号"></btmborder>
        </div>
        <div>
            <btmborder @getData="getPass" type="password" name="密码" placeholder="请输入密码"></btmborder>
        </div>
        <div class="cz">
