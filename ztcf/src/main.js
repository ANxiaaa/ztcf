...
document.addEventListener('click', function(){
    console.log(plus)
    // plus.device.dial(15838020224, true); // 拨打电话
    // plus.runtime.appid // appid
})
document.addEventListener('plusready', function() {
    ...
    plus.key.addEventListener('backbutton', function() {
        webview.canBack(function(e) {
            if(location.pathname != '/index' && location.pathname != '/sale' && location.pathname != '/information' && location.pathname != '/insurance' && location.pathname != '/my') {
                webview.back();
            } else {
